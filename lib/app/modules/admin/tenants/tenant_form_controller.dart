...
class TenantFormController extends GetxController {
  ...
  Future<void> _createTenant() async {
    ...
    if (emailController.text.isNotEmpty && passwordController.text.isNotEmpty) {
      try {
        print('🔐 Creating auth user for: ${emailController.text.trim()}');
      ...
      print('⚠️ No email/password provided - tenant will be created without login account');
    }

    print('📝 Creating tenant with userId: $userId');
    final tenant = Tenant(
